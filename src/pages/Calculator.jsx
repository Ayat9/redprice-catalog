    ...
    <div className="calculator-page">
      <div className="calculator-container">
        ...
        <div className="calculator-keypad">
          <button className="calculator-button calculator-button-function" onClick={clear}>
            AC
          </button>
          <button className="calculator-button calculator-button-function" onClick={handleDelete}>
            DEL
          </button>
          ...
          <button className="calculator-button calculator-button-zero" onClick={() => inputNumber(0)}>0</button>
